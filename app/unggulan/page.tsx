...
export default function UnggulanPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white w-full">
      <h1 className="text-2xl font-bold mb-6 text-center pt-8">Konten Unggulan</h1>
                      ...
                      >
                        ...
                        {expandedComic !== comic.id && (
                          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/60 rounded-full px-3 py-1 flex items-center gap-2">
                            ...
                            <span className="text-xs text-white">Swipe untuk detail</span>
                          </div>
                        )}
                      </div>
                        ...
                        {comic.teaserVideo ? (
                          ...
                          <div className="w-full h-full bg-gray-800 flex items-center justify-center">
                            <div className="text-center">
                              ...
                              <div className="text-sm text-gray-400">Video tidak tersedia</div>
                            </div>
                          </div>
                        )}
